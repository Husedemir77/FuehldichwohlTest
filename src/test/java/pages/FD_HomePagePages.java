...
public class FD_HomePagePages extends ParentClass {
    ...
    public void checkTheButtons() {
        ...
        for (int i = 0; i < mainTabList.size(); i++) {
            ...
            buiilder.moveToElement(mainTabList.get(i)).perform();
            waiting(500);
            //  if (i>0&& i<4) {
    ...
    public void searchFunction() {
     ...
     By asdaf = By.xpath("(//div[@class='gm-actions']/div)[1]");
     driver.findElement(asdaf).click();
    ...
    public void scrolling() {
        ...
        By backToTop = By.xpath("//a[@id='qodef-back-to-top']");
        By warenkorbLeer = By.xpath("//p[@class='woocommerce-mini-cart__empty-message']");
        By warenkorb = By.xpath("(//a[@class='gm-minicart-link'])[2]");
